...
# Paths
JAKE_ROOT = Path(__file__).parent.parent.resolve()
GOLDEN_ROOT = JAKE_ROOT.parent.parent / "leo-container-golden"
...
def main():
    ...
    if not GOLDEN_ROOT.exists():
        ...
        print("Expected: /Users/jake/WORK/LEO/leo-container-golden")
        return 1
