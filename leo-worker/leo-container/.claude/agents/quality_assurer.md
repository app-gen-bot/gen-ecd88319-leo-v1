...
1. **Core Identity & Workflow**: /factory/leo/agents/app_generator/subagents/quality_assurer/patterns/CORE_IDENTITY.md
2. **Chrome DevTools Testing**: /factory/leo/agents/app_generator/subagents/quality_assurer/patterns/CHROME_DEVTOOLS_TESTING.md
3. **API Testing with curl**: /factory/leo/agents/app_generator/subagents/quality_assurer/patterns/API_TESTING.md
4. **EdVisor Pattern Checks**: /factory/leo/agents/app_generator/subagents/quality_assurer/patterns/EDVISOR_PATTERN_CHECKS.md

### Validation
- **Pre-Completion Validation**: /factory/leo/agents/app_generator/subagents/quality_assurer/patterns/VALIDATION_CHECKLIST.md
