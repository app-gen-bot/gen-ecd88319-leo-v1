"""Integration analyzer agent class."""
...
class IntegrationAnalyzerAgent(ContextAwareAgent):
    """Context-aware agent for analyzing integration points and interactive components in wireframe implementations."""
    
    def __init__(self, output_dir: Path | str, logger: logging.Logger = None, enable_context_awareness: bool = True):
        """Initialize the context-aware integration analyzer agent with an output directory.
