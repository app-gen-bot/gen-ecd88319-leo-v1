...
class CriticAgent(ContextAwareAgent):
    """Context-aware agent for evaluating wireframe implementations and deciding on iteration."""
    
    def __init__(self, output_dir: Path | str, logger: logging.Logger = None, enable_context_awareness: bool = True):
        """Initialize the context-aware critic agent with an output directory.
