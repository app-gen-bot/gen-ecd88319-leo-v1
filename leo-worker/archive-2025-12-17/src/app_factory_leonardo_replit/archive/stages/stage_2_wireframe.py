...
from app_factory_leonardo_replit.agents.stage_2_wireframe.wireframe import WireframeAgent, create_wireframe_prompt
from app_factory_leonardo_replit.agents.stage_2_wireframe.qc import QCAgent, create_qc_prompt
from app_factory_leonardo_replit.agents.stage_2_wireframe.integration_analyzer import IntegrationAnalyzerAgent, create_integration_analyzer_prompt
from app_factory_leonardo_replit.agents.retrospective import RetrospectiveAgent, create_retrospective_prompt
from app_factory_leonardo_replit.utils import Timer
from app_factory_leonardo_replit.paths import get_frontend_dir
...
async def run_stage_from_critic(app_name: str, start_iteration: int, previous_feedback: str = None, output_dir: Path = None) -> AgentResult:
    ...
    from app_factory_leonardo_replit.agents.stage_2_wireframe.critic import CriticAgent, create_critic_prompt
    from app_factory_leonardo_replit.agents.stage_2_wireframe.critic.config import AGENT_CONFIG
