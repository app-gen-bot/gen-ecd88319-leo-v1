...
from app_factory_leonardo_replit.agents.stage_1_interaction_spec import interaction_spec_agent
from app_factory_leonardo_replit.agents.stage_1_interaction_spec.critic import CriticAgent
...
async def _run_iterative_mode(prd_content: str, app_name: str, app_dir: Optional[Path] = None) -> AgentResult:
    ...
    from app_factory_leonardo_replit.agents.stage_1_interaction_spec.critic.config import AGENT_CONFIG
