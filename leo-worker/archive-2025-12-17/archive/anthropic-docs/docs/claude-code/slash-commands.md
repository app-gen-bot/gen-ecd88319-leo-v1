...
| --- | --- |
| <prefix> | Command scope (projectfor project-specific,userfor personal) |
| <command-name> | Name derived from the Markdown filename (without.mdextension) |
...
**Location**:`.claude/commands/`**Prefix**:`/project:`
...
**Location**:`~/.claude/commands/`**Prefix**:`/user:`
...
[Interactive mode](https://docs.anthropic.com/en/docs/claude-code/interactive-mode)[Settings](https://docs.anthropic.com/en/docs/claude-code/settings)On this page
