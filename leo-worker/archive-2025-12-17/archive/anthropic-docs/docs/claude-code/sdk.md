...
| executable | Which JavaScript runtime to use | nodewhen running with Node.js,bunwhen running with Bun |
...
[GitHub Actions](https://docs.anthropic.com/en/docs/claude-code/github-actions)[Troubleshooting](https://docs.anthropic.com/en/docs/claude-code/troubleshooting)On this page
