...
- All[standard attributes](https://docs.anthropic.com/_sites/docs.anthropic.com/en/docs/claude-code/monitoring-usage#standard-attributes)
...
| --- | --- |
| claude_code.token.usage | Break down bytype(input/output), user, team, or model |
...
[Security](https://docs.anthropic.com/en/docs/claude-code/security)[Costs](https://docs.anthropic.com/en/docs/claude-code/costs)On this page
