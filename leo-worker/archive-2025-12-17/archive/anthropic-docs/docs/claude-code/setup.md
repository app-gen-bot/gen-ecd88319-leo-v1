...
[Overview](https://docs.anthropic.com/en/docs/claude-code/overview)[Quickstart](https://docs.anthropic.com/en/docs/claude-code/quickstart)On this page
...
- [Custom notification hooks](https://docs.anthropic.com/en/docs/claude-code/setup#custom-notification-hooks)
