...
usage. Review[Security Considerations](https://docs.anthropic.com/_sites/docs.anthropic.com/en/docs/claude-code/hooks#security-considerations).
...
Claude Code hooks work seamlessly with[Model Context Protocol (MCP) tools](https://docs.anthropic.com/en/docs/claude-code/mcp). When MCP servers
...
2. Verify that your[settings files](https://docs.anthropic.com/en/docs/claude-code/settings)are valid
JSON
...
[Settings](https://docs.anthropic.com/en/docs/claude-code/settings)[Data usage](https://docs.anthropic.com/en/docs/claude-code/data-usage)On this page
- [Introduction](https://docs.anthropic.com/en/docs/claude-code/hooks#introduction)
- [Quickstart](https://docs.anthropic.com/en/docs/claude-code/hooks#quickstart)
- [Step 1: Open hooks configuration](https://docs.anthropic.com/en/docs/claude-code/hooks#step-1%3A-open-hooks-configuration)
- [Step 2: Add a matcher](https://docs.anthropic.com/en/docs/claude-code/hooks#step-2%3A-add-a-matcher)
- [Step 3: Add the hook](https://docs.anthropic.com/en/docs/claude-code/hooks#step-3%3A-add-the-hook)
- [Step 4: Save your configuration](https://docs.anthropic.com/en/docs/claude-code/hooks#step-4%3A-save-your-configuration)
- [Step 5: Verify your hook](https://docs.anthropic.com/en/docs/claude-code/hooks#step-5%3A-verify-your-hook)
...
- [JSON Output Example: Bash Command Editing](https://docs.anthropic.com/en/docs/claude-code/hooks#json-output-example%3A-bash-command-editing)
...
- [Code Formatting](https://docs.anthropic.com/en/docs/claude-code/hooks#code-formatting)
- [Notification](https://docs.anthropic.com/en/docs/claude-code/hooks#notification-2)
