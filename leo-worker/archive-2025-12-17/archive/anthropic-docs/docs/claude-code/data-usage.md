...
| --- | --- | --- | --- |
| Statsig (Metrics) | Default on.DISABLE_TELEMETRY=1to disable. | Default off.CLAUDE_CODE_USE_VERTEXmust be 1. | Default off.CLAUDE_CODE_USE_BEDROCKmust be 1. |
| Sentry (Errors) | Default on.DISABLE_ERROR_REPORTING=1to disable. | Default off.CLAUDE_CODE_USE_VERTEXmust be 1. | Default off.CLAUDE_CODE_USE_BEDROCKmust be 1. |
| Anthropic API (/bugreports) | Default on.DISABLE_BUG_COMMAND=1to disable. | Default off.CLAUDE_CODE_USE_VERTEXmust be 1. | Default off.CLAUDE_CODE_USE_BEDROCKmust be 1. |
...
[Hooks](https://docs.anthropic.com/en/docs/claude-code/hooks)[Legal and compliance](https://docs.anthropic.com/en/docs/claude-code/legal-and-compliance)On this page
