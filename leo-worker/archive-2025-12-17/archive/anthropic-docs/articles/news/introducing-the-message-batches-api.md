...
**Published:** APIOct 8, 2024
**Source:** https://www.anthropic.com/news/message-batches-api

ProductOct 8, 2024●2 min  read![Illustration of a hand reaching for a batch of requests](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2Fe1abfa59e8b7543c8bf9b3c83132b983151144ab-5760x3240.png&w=3840&q=75)
*Update: As of December 17, 2024, the Message Batches API is Generally Available on the Anthropic API. Customers using Claude in Amazon Bedrock can use batch inference. Batch predictions is also available in preview on Google Cloud’s Vertex AI.*We’re introducing a new [Message Batches API](https://docs.anthropic.com/en/docs/build-with-claude/message-batches)—a powerful, cost-effective way to process large volumes of queries asynchronously.
...
To start using the Batches API in public beta on the Anthropic API, explore our [documentation](https://docs.anthropic.com/en/docs/build-with-claude/message-batches) and [pricing page](https://www.anthropic.com/pricing#anthropic-api).
