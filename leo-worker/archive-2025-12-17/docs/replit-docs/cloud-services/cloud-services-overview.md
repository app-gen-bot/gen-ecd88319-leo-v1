...
**Scraped:** 2025-09-08 20:10:45

---

Publishing your AppOverviewCopy pageShare your Replit Apps with the world in just a few clicks.Copy page
...
[Autoscale DeploymentAutomatically adjusts resources based on your app’s usage.](https://docs.replit.com/cloud-services/deployments/autoscale-deployments)

[Static DeploymentProvides an affordable way to host websites that don’t change based on user input.](https://docs.replit.com/cloud-services/deployments/static-deployments)

[Reserved VM DeploymentProvides a consistent amount of computing resources for your app to run continuously.](https://docs.replit.com/cloud-services/deployments/reserved-vm-deployments)

[Scheduled DeploymentRuns your app at scheduled times that you choose.](https://docs.replit.com/cloud-services/deployments/scheduled-deployments)
...
1. In the Publishing tab, select your publishing option.
1. If Add a payment method appears, follow the prompts to add a payment method.
...
- Autoscale Deployment: Learn how to set up applications that scale with traffic
- Static Deployment: Discover how to publish static websites quickly and efficiently
- Reserved VM Deployment: Explore dedicated VM options for specialized use cases
- Scheduled Deployment: Set up recurring tasks with simple scheduling
- Custom Domains: Connect your published app to a custom domain
...
[Previous](https://docs.replit.com/replit-workspace/replit-themes)

[Autoscale DeploymentsAutoscale Deployments publish your Replit App to cloud servers that adjust automatically to handle your app's traffic and workload.Next](https://docs.replit.com/cloud-services/deployments/autoscale-deployments)
