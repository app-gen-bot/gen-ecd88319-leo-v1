...
**Section:** extensions  
**Scraped:** 2025-09-08 20:13:25

---

ExamplesJSON EditorCopy pageBuild a custom JSON editor extension for Replit using React and react-json-view to enable structured editing and code folding of JSON files.Copy page
...
1. Install the react-json-view package with npm install --force react-json-view. The package uses React 17 as a peer dependency but works fine with React 18 as well.
...
Install the Extension by opening up the Command Bar (cmd/ctrl + k), navigating to Extensions, and selecting From this Replit App. The extension should load and display “Ready” almost instantly.
...
[Previous](https://docs.replit.com/extensions/development/react/hooks/useWatchTextFile)

[Snippet ManagerLearn how to build a snippet manager extension that lets developers store and organize code snippets directly within the Replit workspace.Next](https://docs.replit.com/extensions/examples/snippet-manager)
