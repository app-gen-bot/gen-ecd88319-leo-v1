...
**Section:** extensions  
**Scraped:** 2025-09-08 20:13:31

---

ExamplesSnippet ManagerCopy pageLearn how to build a snippet manager extension that lets developers store and organize code snippets directly within the Replit workspace.Copy page
...
1. Install the react-feather package with npm install react-feather.
...
[Previous](https://docs.replit.com/extensions/examples/json-editor)

[JavaScript CommandsLearn how to build an extension that adds JavaScript-related commands to Replit for managing npm packages and running scripts.Next](https://docs.replit.com/extensions/examples/javascript-commands)
