...
**Source:** https://docs.replit.com/replit-workspace/replit-auth  
**Section:** replit-workspace  
**Scraped:** 2025-09-08 20:07:26

---

FeaturesReplit AuthCopy pageAdd user accounts, personalized experiences, and secure access control to your app. Enterprise-grade authentication that works with a single Agent prompt.Copy page
...
[Previous](https://docs.replit.com/replit-workspace/workspace-features/preview)

[SecretsThe Secrets workspace tool lets you securely store sensitive information your app needs as encrypted environment variables.Next](https://docs.replit.com/replit-workspace/workspace-features/secrets)
