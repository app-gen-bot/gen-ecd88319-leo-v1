...
prompt specific to software engineering. Neither CLAUDE.md nor`--append-system-prompt`edit Claude Code’s default system prompt. CLAUDE.md
...
[Subagents](https://docs.anthropic.com/en/docs/claude-code/sub-agents)[Hooks](https://docs.anthropic.com/en/docs/claude-code/hooks-guide)On this page
