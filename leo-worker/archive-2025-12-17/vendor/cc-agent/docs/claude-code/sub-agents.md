...
- **Omit thetoolsfield**to inherit all tools from the main thread (default), including MCP tools
...
[Common workflows](https://docs.anthropic.com/en/docs/claude-code/common-workflows)[Output styles](https://docs.anthropic.com/en/docs/claude-code/output-styles)On this page
