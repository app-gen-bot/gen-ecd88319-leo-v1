...
To view the TypeScript SDK source code, visit the[@anthropic-ai/claude-codepage on NPM](https://www.npmjs.com/package/@anthropic-ai/claude-code?activeTab=code).
...
| executable | 'bun' | 'deno' | 'node' | Which JavaScript runtime to use | nodewhen running with Node.js,bunwhen running with Bun |
...
[Python](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python)[Overview](https://docs.anthropic.com/en/docs/claude-code/third-party-integrations)On this page
- [Prerequisites](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#prerequisites)
- [Installation](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#installation)
- [Basic usage](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#basic-usage)
- [Configuration options](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#configuration-options)
- [Multi-turn conversations](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#multi-turn-conversations)
- [Resume with session management](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#resume-with-session-management)
- [Streaming input mode](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#streaming-input-mode)
- [Streaming input with images](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#streaming-input-with-images)
- [Custom system prompts](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#custom-system-prompts)
- [Custom tools via MCP](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#custom-tools-via-mcp)
- [Custom tools with in-process MCP servers](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#custom-tools-with-in-process-mcp-servers)
- [Creating custom tools](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#creating-custom-tools)
- [Type safety with Zod](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#type-safety-with-zod)
- [Permission control](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#permission-control)
- [Benefits of SDK MCP servers](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#benefits-of-sdk-mcp-servers)
- [Custom tools using external MCP servers](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#custom-tools-using-external-mcp-servers)
- [Output formats](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#output-formats)
- [Text output (default)](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#text-output-default)
- [JSON output](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#json-output)
- [Input formats](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#input-formats)
- [Agent integration examples](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#agent-integration-examples)
- [SRE incident response agent](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#sre-incident-response-agent)
- [Automated security review](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#automated-security-review)
- [Multi-turn legal assistant](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#multi-turn-legal-assistant)
- [Message schema](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#message-schema)
- [Related resources](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript#related-resources)