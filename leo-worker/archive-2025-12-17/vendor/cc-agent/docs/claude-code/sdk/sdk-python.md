...
The Python SDK accepts all arguments supported by the[command line](https://docs.anthropic.com/en/docs/claude-code/cli-reference)through the`ClaudeCodeOptions`class.
...
[Headless mode](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-headless)[TypeScript](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-typescript)On this page
- [Prerequisites](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#prerequisites)
- [Installation](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#installation)
- [Quick start](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#quick-start)
- [Basic usage](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#basic-usage)
- [1. The ClaudeSDKClient class (recommended)](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#1-the-claudesdkclient-class-recommended)
- [2. The query function](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#2-the-query-function)
- [Configuration options](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#configuration-options)
- [ClaudeCodeOptions parameters](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#claudecodeoptions-parameters)
- [Parameter details](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#parameter-details)
- [Permission modes](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#permission-modes)
- [Advanced configuration example](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#advanced-configuration-example)
- [Structured messages and image inputs](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#structured-messages-and-image-inputs)
- [Multi-turn conversations](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#multi-turn-conversations)
- [Method 1: Using ClaudeSDKClient for persistent conversations](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#method-1%3A-using-claudesdkclient-for-persistent-conversations)
- [Custom system prompts](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#custom-system-prompts)
- [Custom tools via MCP](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#custom-tools-via-mcp)
- [Custom permission prompt tool](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#custom-permission-prompt-tool)
- [Output formats](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#output-formats)
- [Text output with streaming](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#text-output-with-streaming)
- [JSON output with metadata](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#json-output-with-metadata)
- [Input formats](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#input-formats)
- [Agent integration examples](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#agent-integration-examples)
- [SRE incident response agent](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#sre-incident-response-agent)
- [Automated security review](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#automated-security-review)
- [Multi-turn legal assistant](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#multi-turn-legal-assistant)
- [Python-specific best practices](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#python-specific-best-practices)
- [Key patterns](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#key-patterns)
- [IPython/Jupyter tips](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#ipython%2Fjupyter-tips)
- [Related resources](https://docs.anthropic.com/en/docs/claude-code/sdk/sdk-python#related-resources)