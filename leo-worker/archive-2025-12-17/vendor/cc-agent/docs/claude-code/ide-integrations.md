...
Install the[Claude Code plugin](https://docs.anthropic.com/s/claude-code-jetbrains)from
...
For additional help, refer to our[troubleshooting guide](https://docs.anthropic.com/en/docs/claude-code/troubleshooting)or reach out to
support.
[Common workflows](https://docs.anthropic.com/en/docs/claude-code/common-workflows)[Model Context Protocol (MCP)](https://docs.anthropic.com/en/docs/claude-code/mcp)On this page
