...
[Add Claude Code to your IDE](https://docs.anthropic.com/en/docs/claude-code/ide-integrations)[Model configuration](https://docs.anthropic.com/en/docs/claude-code/model-config)On this page
