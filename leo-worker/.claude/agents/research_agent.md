...
tools: TodoWrite, WebSearch, WebFetch, Read, Write, mcp__mem0__add_memory, mcp__context_manager__analyze_query, mcp__chrome_devtools__new_page, mcp__chrome_devtools__navigate_page, mcp__chrome_devtools__take_screenshot, mcp__chrome_devtools__close_page
