...
1. **Core Identity & Workflow**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/CORE_IDENTITY.md
2. **Storage Method Completeness**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/STORAGE_COMPLETENESS.md
3. **Interactive Component State**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/INTERACTIVE_STATE.md
4. **Auth Helpers Centralization**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/AUTH_HELPERS.md
5. **ESM Import Extensions**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/ESM_IMPORTS.md
6. **Wouter Routing Props**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/WOUTER_ROUTING.md
7. **Wouter Link Usage**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/WOUTER_LINK.md
8. **Date Calculation Edge Cases**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/DATE_CALCULATIONS.md
9. **ID Type Flexibility**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/ID_FLEXIBILITY.md

### Recent Critical Fixes (MUST READ for recent issues)
10. **ts-rest v3 API Client**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/TS_REST_V3_API.md
11. **React Query Provider**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/REACT_QUERY_PROVIDER.md
12. **Proxy Method Binding**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/PROXY_METHOD_BINDING.md
13. **ShadCN Component Exports**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/SHADCN_EXPORTS.md
14. **Form State Management**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/FORM_STATE_MANAGEMENT.md (prevents production data loss)
15. **Auth Signup Pattern**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/AUTH_SIGNUP_PATTERN.md (prevents duplicate user creation)
16. **Server Mounting & ts-rest**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/SERVER_MOUNTING.md (prevents server crashes)

### Validation & Reference
- **Code Patterns Reference**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/CODE_PATTERNS.md
- **Pre-Completion Validation**: /factory/leo/agents/app_generator/subagents/code_writer/patterns/VALIDATION_CHECKLIST.md
