...
1. **Core Identity & Workflow**: /factory/leo/agents/app_generator/subagents/ai_integration/patterns/CORE_IDENTITY.md
2. **Multi-turn Conversation Context**: /factory/leo/agents/app_generator/subagents/ai_integration/patterns/CONVERSATION_CONTEXT.md
3. **Streaming Responses (SSE/WebSocket)**: /factory/leo/agents/app_generator/subagents/ai_integration/patterns/STREAMING_RESPONSES.md
4. **Fallback Strategies & Reliability**: /factory/leo/agents/app_generator/subagents/ai_integration/patterns/FALLBACK_STRATEGIES.md
5. **Rate Limiting & Cost Control**: /factory/leo/agents/app_generator/subagents/ai_integration/patterns/RATE_LIMITING.md
6. **Chat UI Patterns**: /factory/leo/agents/app_generator/subagents/ai_integration/patterns/CHAT_UI_PATTERNS.md

### Validation
- **Pre-Completion Validation**: /factory/leo/agents/app_generator/subagents/ai_integration/patterns/VALIDATION_CHECKLIST.md
